/**
 * IV 分析頁：Call/Put 切換、到期日載入、查詢送出、結果渲染、觀察清單。
 *
...
export function init() {
  (function () {
    ...
    // Mode toggle buttons
    document.getElementById('dash-mode-ivr').addEventListener('click', function() { window.switchDashMode('ivr'); });
    document.getElementById('dash-mode-skew').addEventListener('click', function() { window.switchDashMode('skew'); });
