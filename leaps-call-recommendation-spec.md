...
- [ ] **人工已知值對照（fixture 層）**：NVTS 2026-07-02 快照數值（spot 14.46；strike 5 → 內在 9.46/外在 1.54/佔比 14%；strike 10 → 內在 4.46/外在 4.87/佔比 52%）以單元測試 fixture 釘住公式並通過。
- [ ] **人工已知值對照（live 層）**：核心情境 E2E 當次抓到的資料任取兩筆,以當次 bid/ask/spot 手算並與頁面顯示值一致,回報附手算過程。**不得**拿 live 輸出去對 2026-07-02 的歷史數值。
