...
ActiveRecord::Schema[8.1].define(version: 2026_09_01_093000) do
  ...
  create_table "pmcc_positions", force: :cascade do |t|
    ...
    t.index ["user_id", "ticker", "status"], name: "index_pmcc_positions_on_user_id_and_ticker_and_status"
    t.index ["user_id"], name: "index_pmcc_positions_on_user_id"
  ...
  add_foreign_key "pmcc_positions", "users"
