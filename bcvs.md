...
| 3 前端 | ✅ 已完成（v3 視覺改版，見下方清單逐項打勾＋證據）| `app/components/bull_call_spreads/page_component.rb` |
| 4 端到端驗收 | ✅ 已完成 | NOK K1=$7/K2=$12/2028-01-21 全流程 Playwright 驗證；三卡色帶/3D 圖示/hover 淡紫皆截圖確認 |
...
**字級鐵則**：內文與表格一律 **14px**，卡帶標題 15px/500，禁止其他字級混用。
